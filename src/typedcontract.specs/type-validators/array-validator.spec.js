...
describe("ArrayValidator", function () {
    ...
    it("isNotNull returns the right validator as a postcondition", function () {
        var localVar = [1, 2, 3];
        var result = contract.Out(localVar).isNotNull();
        expect(result);
    });
    ...
    it("isNull returns the right validator as a postcondition", function () {
        var localVar = null;
        var result = contract.Out(localVar).isNull();
        expect(result);
    });
    ...
    it("isEqualTo returns the proper validator with an array and index given", function () {
        var localVar = [1, 2, 3];
        var compareTo = [1, 2, 3];
        var result = contract.In(localVar).isEqualTo(compareTo, 0);
        expect(result);
    });
    ...
    it("isLengthGreaterThan throws an error when given a contract.In() precondition and comparable for a string array", function () {
        var localVar = ["A", "B", "C"];
    ...
    it("isLengthGreaterThan throws an error when given a contract.In() precondition and comparable for an empty value arrays", function () {
        var localVar = [];
        var compareTo = ["1"];
        expect(function () {
            contract.In(localVar).isLengthGreaterThan(compareTo);
    ...
    it("isLengthGreaterThan throws an error when given a contract.In() precondition and comparable for an empty comparison arrays", function () {
        var localVar = ["1"];
        var compareTo = [];
        expect(function () {
            contract.In(localVar).isLengthGreaterThan(compareTo);
