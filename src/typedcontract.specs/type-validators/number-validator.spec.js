...
describe("NumberValidator", function () {
    it("isGreaterThan returns the right validator", function () {
        ...
        var localVariable = 2;
        // act
        var result = contract.In(localVariable).isGreaterThan(1);
        // assert
        expect(result);
    });
    it("isGreaterThan returns the right validator if passed a double/float", function () {
        ...
        var comparableVar = 1;
        // act
        var result = contract.In(localVariable).isGreaterThan(comparableVar);
        // assert
        expect(result);
    });
    ...
    it("isNullOrUndefined returns proper validator if defined", function () {
        var localVar = 0;
        var result = contract.In(localVar).isNullOrUndefined();
        expect(result);
    });
    it("isEqualTo returns the proper validator when given an equal value", function () {
        var localVar = 1;
        var result = contract.In(localVar).isEqualTo(1);
        expect(result);
    });
    ...
    it("isEqualTo returns the proper validator when given a double value", function () {
        var localVar = 10.00;
        var result = contract.In(localVar).isEqualTo(10.00);
        expect(result);
    });
    ...
    it("isGreaterThan returns the proper validator when given a value that is greater than the precondition", function () {
        var localVar = 1;
        var compareTo = 0;
        var result = contract.In(localVar).isGreaterThan(compareTo);
        expect(result);
    });
    ...
    it("isNotGreaterThan returns the proper validator when given a value that is less than the compareTo variable", function () {
        var localVar = 1;
        var compareTo = 3;
        var result = contract.In(localVar).isNotGreaterThan(compareTo);
        expect(result);
    });
    ...
    it("isGreaterOrEqualThan returns the proper validator when the precondition is greater the precondition", function () {
        var localVar = 4;
        var compareTo = 3;
        var result = contract.In(localVar).isGreaterOrEqualThan(compareTo);
        expect(result);
    });
    ...
    it("isNotGreaterOrEqualThan returns the proper validator when the precondition is equal to the comparable", function () {
        var localVar = 4;
        var compareTo = 4;
        var result = contract.In(localVar).isNotGreaterOrEqualThan(compareTo);
        expect(result);
    });
    ...
    it("isLessThan returns the proper validator when the precondition is less than the comparable", function () {
        var localVar = 6;
        var compareTo = 10;
        var result = contract.In(localVar).isLessThan(compareTo);
        expect(result);
    });
    ...
    it("isNotLessThan returns the proper validator when the precondition is not less than the comparable", function () {
        var localVar = 3;
        var compareTo = 2;
        var result = contract.In(localVar).isNotLessThan(compareTo);
        expect(result);
    });
    ...
    it("isNotBetween returns the proper validator when the precondition is not in the range specified", function () {
        ...
        var startRange = 60;
        var endRange = 100;
        var result = contract.In(localVar).isNotBetween(startRange, endRange);
        expect(result);
    });
...
//# sourceMappingURL=number-validator.spec.js.map