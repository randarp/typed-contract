...
describe("StringValidator", function () {
    ...
    it("isWhitespace with a valid string expects an error to be thrown", function () {
        // arrange
        var localVariable = "Andre";
        // act/assert
        expect(function () {
    ...
    it("isWhitespace with an empty string passes", function () {
        // arrange
        var localVariable = "";
        // act
        var result = contract.In(localVariable).isWhitespace();
        // assert
        expect(result).not.toBe(null);
        expect(result.constructor.name).toBe("StringValidator");
    });
    it("isWhitespace with a whitespace string passes", function () {
        // arrange
        var localVariable = "    ";
        // act
        var result = contract.In(localVariable).isWhitespace();
    ...
    it("isNotWhitespace with a valid string passes", function () {
        // arrange
        var localVariable = "Andre";
        // act
        var result = contract.In(localVariable).isNotWhitespace();
        // assert
        expect(result).not.toBe(null);
        expect(result.constructor.name).toBe("StringValidator");
    });
    it("isNotWhitespace with an empty string throws an error", function () {
        // arrange
        var localVariable = "";
        // act/assert
        expect(function () {
    ...
    it("isNotWhitespace with a whitespace string throws an error", function () {
        // arrange
        var localVariable = "    ";
        // act/assert
        expect(function () {
    ...
    it("isNotWhitespace and isNotNull chained with a whitespace string throws an error", function () {
        // arrange
        var localVariable = "    ";
        // act/assert
        expect(function () {
    ...
    it("isDefined and isNotNull should return the proper result ", function () {
        var localVar = "Andre";
        var result = contract.In(localVar).isNotNull().isDefined();
        expect(result).toBeDefined();
    });
    ...
    it("isNotDefined return the proper result", function () {
        ...
        var result = contract.In(localVar).isUndefined();
        expect(result);
    });
    ...
    it("isEqualTo returns the proper validator when given a string that is equal", function () {
        ...
        var result = contract.In(localVar).isEqualTo(compareTo);
        expect(result);
    });
    ...
    it("isNotEqualTo returns the proper validator when given an unequal string", function () {
        var localVar = "TypedContract";
        var compareTo = "TypeScript";
        var result = contract.In(localVar).isNotEqualTo(compareTo);
        expect(result);
    });
    ...
    it("IsLengthGreater than returns the proper validator when given a string longer than the comparable", function () {
        var localVar = "TypedContract";
        var compareTo = "TypeScript";
        var result = contract.In(localVar).isLengthGreaterThan(compareTo);
        expect(result);
    });
    ...
    it("isLengthGreaterOrEqualTo returns the proper validator when given an string the is smaller than the comparable", function () {
        var localVar = "Andre";
        var compareTo = "Andy";
        var result = contract.In(localVar).isLengthGreaterOrEqualTo(compareTo);
        expect(result);
    });
    ...
    it("isLengthNotGreaterThan throws an error with the proper validator when given a comparable", function () {
        ...
        var result = contract.In(localVar).isLengthNotGreaterThan(compareTo);
        expect(result);
    });
    ...
    it("isLengthNotGreaterOrEqualTo returns the proper validator when given a comparable string that is not greater in length", function () {
        ...
        var result = contract.In(localVar).isLengthNotGreaterOrEqualTo(compareTo);
        expect(result);
    });
    ...
    it("isLengthLessThan returns the proper validator when given a string argument that is greater than comparable", function () {
        var localVar = "TypeScript";
        var compareTo = "TypedContract";
        var result = contract.In(localVar).isLengthLessThan(compareTo);
        expect(result);
    });
    ...
    it("isLengthNotLessThan returns the proper validator when given a string argument that is greater than the comparable", function () {
        var localVar = "TypedContract";
        var compareTo = "TypeScript";
        var result = contract.In(localVar).isLengthNotLessThan(compareTo);
        expect(result);
    });
    ...
    it("isLengthLessOrEqual to returns the proper validator when given a precondition that is less than in length than the comparable", function () {
        ...
        var result = contract.In(localVar).isLengthLessOrEqualThan(compareTo);
        expect(result);
    });
    ...
    it("isLengthNotLessOrEqual to return the proper validator when given a string not smaller than the comparable", function () {
        var localVar = "TypedContract";
        var compareTo = "TypeScript";
        var result = contract.In(localVar).isLengthNotLessOrEqualThan(compareTo);
        expect(result);
    });
    ...
    it("toMatch returns true when given the proper regular expression with a case insensitive regular expression", function () {
        ...
        var regExp = /andre/i;
        var result = contract.In(localVar).toMatch(regExp);
        expect(result);
    });
    ...
    it("toNotMatch returns the proper validator when given the proper regular expression with a case insensitive regular expression that does not match the string", function () {
        var localVar = "Hello my name is andre";
        var regExp = /bob/i;
        var result = contract.In(localVar).toNotMatch(regExp);
        expect(result);
    });
    ...
    it("contains returns the proper validator when given a string that contains the same characters as the contract precondition", function () {
        ...
        var compareTo = "TypeScript";
        var result = contract.In(localVar).contains(compareTo);
        expect(result);
    });
    ...
    it("notContains returns the proper valuidator when given a string that does" +
        ...
        var localVar = "This is a TypeScript library";
        var compareTo = "Contract";
        var result = contract.In(localVar).notContains(compareTo);
        expect(result);
    });
    ...
    it("startsWith returns the proper validator when given a string " +
        ...
        var result = contract.In(localVar).startsWith(compareTo);
        expect(result);
    });
    ...
    it("endsWith returns the proper validator when given to identical strings", function () {
        ...
        var compareTo = "Randar";
        var result = contract.In(localVar).endsWith(compareTo);
        expect(result);
    });
    ...
    it("isBetween returns the proper validator when given two strings", function () {
        var localVar = "T";
        var result = contract.In(localVar).isBetween("A", "Z");
        expect(result);
    });
    ...
    it("isBetween returns the proper validator when given two identical strings", function () {
        var localVar = "b";
        var result = contract.In(localVar).isBetween("a", "c");
        expect(result);
    });
    ...
    it("isNotBetween returns the proper validator when given two strings that are not in the range of the precondition", function () {
        var localVar = "Cxy";
        var result = contract.In(localVar).isNotBetween("Dzz", "Aab");
        expect(result);
    });
    it("isNotBetween returns the proper validator when given two non-identical strings", function () {
        var localVar = "Free";
        var result = contract.In(localVar).isNotBetween("Guy", "Acd");
        expect(result);
    });
